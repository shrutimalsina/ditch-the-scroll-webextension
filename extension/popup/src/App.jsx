...
function App() {
  ...
  return(
    ...
    <div className="everything font-[Iosevka_Charon] text-2xl text-center w-96 min-h-[28rem] flex flex-col rounded-2xl shadow-2xl overflow-hidden border border-rose-200">
     <div className="h-1 bg-gradient-to-r from-[#FED7AA] via-[#FDBA74] to-[#FED7AA]"></div> 
      <div className='header bg-gradient-to-r from-[#FFEAD5] to-[#FFE4C4] text-black p-5 relative'>
      ...
      <div className='greeting flex-1 bg-gradient-to-b from-[#FFF7E6] to-[#F5E6D6] text-[#3F2A1A] p-6 space-y-3'>
        ...
        <div className='bg-white/50 backdrop-blur-sm rounded-xl p-3 shadow-inner'>
          <p className='text-[#4B3621]'>You've been scrolling on {currentSite} for</p>
          <p className='text-4xl font-bold text-[#F97316] animate-pulse mt-1'>
            {scrollTime}
            <span className='text-2xl ml-1'>min(s)</span>
          </p>
        </div>
      </div>

      <div className='nudge bg-[#FFF1DD] text-[#3F2A1A] p-5 border-y-2 border-rose-200'>
        ...
        <p className='text-sm mt-2 text-[#6B4A2D]'>Please check your phone for a playful nudge</p>
      </div>

      <div className='buttons flex justify-center gap-10 bg-gradient-to-r from-[#FFEAD5] to-[#FFE4C4] p-5'>
        <div className="relative group">
          <button className="transform hover:scale-120 transition-all duration-200 hover:drop-shadow-lg">
            <Coffee size={32} color="#6B4F36" strokeWidth={1.5} />
          </button>
          <span className="absolute -bottom-5 left-1/2 transform -translate-x-1/2 scale-0 group-hover:scale-100 transition-all duration-200 bg-[#3F2A1A] text-white text-xs px-2 py-1 rounded shadow-lg whitespace-nowrap">
            Take a Break
          </span>
        </div>
        ...
        <div className="relative group">
          <button className="transform hover:scale-120 transition-all duration-200 hover:drop-shadow-lg">
            <ChartColumn size={32} color="#6B4F36" strokeWidth={1.5} />
          </button>
          <span className="absolute -bottom-5 left-1/2 transform -translate-x-1/2 scale-0 group-hover:scale-100 transition-all duration-200 bg-[#3F2A1A] text-white text-xs px-2 py-1 rounded shadow-lg whitespace-nowrap">
            See your stats
          </span>
        ...
        <div className="relative group">
          <button className="transform hover:scale-120 transition-all duration-200 hover:drop-shadow-lg">
            <Settings size={32} color="#6B4F36" strokeWidth={1.5} />
          </button>
